...
#include "HLTrigger/Egamma/interface/HLTElectronPixelMatchFilterS.h"
...
DEFINE_FWK_MODULE(HLTElectronPixelMatchFilterS);
DEFINE_FWK_MODULE(HLTElectronPixelMatchFilterAnalysis);
